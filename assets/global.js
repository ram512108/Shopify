function getFocusableElements(container) {
  ...
  class QuantityInput extends HTMLElement {
    constructor() {
      ...
      this.form = this.closest('product-card form');
    ...
    setQuickBuy(){
      this.buyNow = this.form.querySelector('.quick_buy_button');
      const formData = new FormData(this.form);
      this.buyNow.setAttribute('href', `${window.shopUrl}/cart/${formData.get('id')}:${this.input.value}`);
    }
  }
